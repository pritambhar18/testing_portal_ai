...
class TestReportLogger {
     ...
     */
    public function logTestReport($test_link, $pdf_path = null) {
        ...
        try {
            // Insert only the fields that exist in test_reports table
            // execution_date and created_at are auto-generated by database
            ...
            $stmt->bind_param('ss', $test_link, $pdf_path);
